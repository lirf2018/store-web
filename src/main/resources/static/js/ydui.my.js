...
!function (window) {
    ...
    InfiniteScroll.prototype.loadList = function () {
        ...
        if (typeof options.loadListFn == 'function') {
            ...
            // 监听外部获取数据方法，以便获取数据
            options.loadListFn().done(function (hasNext, page) {
...
!function (window) {
    ...
    CitySelect.prototype.createDOM = function () {
        ...
        _this.$cityElement = $('' +
            ...
            '        <p class="cityselect-title"><span>所在地区</span><span><a href="javascript:closeShowYudiAddrDiv()"><i class="icon-x"></i></a></span></p>' +
